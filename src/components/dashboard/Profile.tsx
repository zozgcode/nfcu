...
export default function Profile() {
  ...
  return (
    <div className="w-full h-screen bg-[#FAFAF8]">
        ...
        <button onClick={handleLogout} className="p-3 py-2 rounded-lg border-none outline-none font-medium border smallHeaderContainer text-white text-sm">Sign out</button>
        </div>
        <div className="p-4">
        <div className="bg-white text-sm rounded-lg p-5 py-7 flex flex-col items-center justify-center gap-8 mb-4">
            ...
            <span className="text-[#252525] font-medium flex items-center gap-1">
                <span className="smallHeaderContainer/30 text-black text-xs p-2 py-1 rounded-lg flex items-center gap-1">
